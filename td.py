...
def pause(volume, run):
    ...
    while paused:
        ...
        screen.blit(load_image('pause_table.png', -1), (300, 225))
        screen.blit(load_image('big.png', -1), (345, 400))
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN and zastavka == False:
            ...
            if event.key == pygame.K_ESCAPE:
                pygame.mixer.music.stop()
                volume, running = pause(volume, running)
